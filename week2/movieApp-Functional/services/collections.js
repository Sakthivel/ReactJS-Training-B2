import { getStoredData } from '../view';
import {collectionsList, moviesList, movieCollectionMap, collectionMovieMap, fav_storage} from './config';
...
const getCollectionsListFromLocal = () => getStoredData(fav_storage);
